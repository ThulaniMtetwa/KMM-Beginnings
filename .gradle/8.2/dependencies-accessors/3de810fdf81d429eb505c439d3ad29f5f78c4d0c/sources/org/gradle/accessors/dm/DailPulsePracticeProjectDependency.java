...
@NonNullApi
public class DailPulsePracticeProjectDependency extends DelegatingProjectDependency {

    @Inject
    public DailPulsePracticeProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
